...
class Message extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_message', 'message_id', 'from_user', 'date', 'chat', 'forward_from', 'forward_date', 'reply_to_message', 'id_user'], 'required'],
            [['id_message', 'message_id', 'from_user', 'date', 'chat', 'forward_from', 'forward_date', 'reply_to_message', 'audio', 'photo', 'sticker', 'video', 'contact', 'location', 'new_chat_participant', 'left_chat_participant', 'new_chat_photo', 'delete_chat_photo', 'group_chat_created', 'id_user'], 'integer'],

...
CREATE TABLE IF NOT EXISTS `audio` (
  `idAudio` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents an audio file (voice note).',
...
CREATE TABLE IF NOT EXISTS `bot` (
  `id_bot` int(11) NOT NULL AUTO_INCREMENT COMMENT 'unique id for the bot.',
...
CREATE TABLE IF NOT EXISTS `contact` (
  `idContact` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents a phone contact.',
...
CREATE TABLE IF NOT EXISTS `document` (
  `idDocument` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents a general file (as opposed to photos and audio files).',
...
CREATE TABLE IF NOT EXISTS `file_rules` (
  `id_file_rules` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `force_reply` (
  `idForeceReply` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `groupchat` (
  `idGroupChat` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for this group chat',
...
CREATE TABLE IF NOT EXISTS `location` (
  `idLocation` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents a point on the map.',
...
CREATE TABLE IF NOT EXISTS `photosize` (
  `idPhotoSize` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents one size of a photo or a file / sticker thumbnail.',
  `file_id` varchar(45) NOT NULL COMMENT 'Unique identifier for this file',
...
CREATE TABLE IF NOT EXISTS `replykeyboardhide` (
  ...
  PRIMARY KEY (`idReplyKeyboardHide`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `replykeyboardmarkup` (
  ...
  PRIMARY KEY (`idReplyKeyboardMarkup`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `sticker` (
  `idSticker` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents a sticker.',
  `file_id` varchar(45) NOT NULL COMMENT 'Unique identifier for this file',
...
CREATE TABLE IF NOT EXISTS `telegram_application` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='To be registered as a new api.' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `text_rules` (
  `id_text_rule` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `created_at`, `updated_at`, `level`, `group_id`) VALUES
(1, 'gogl92', 'exWCoRN-5aCInZuutoSQedaO8pySv790', '$2y$13$OylBn.G6Bhi3oCo0Kh7F/.Tyln.URyBtfKnaU7tYv1B1GAf.M6ifq', NULL, 'luisarmando1234@gmail.com', 10, 1435529837, 1435529837, 0, 0);
...
CREATE TABLE IF NOT EXISTS `userprofilephotos` (
  `idUserProfilePhotos` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represent a user''s profile pictures.',
  `total_count` int(11) NOT NULL COMMENT 'Total number of profile pictures the target user has',
  `id_user` int(11) NOT NULL,
  PRIMARY KEY (`idUserProfilePhotos`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `userprofilephotos_photos` (
  `idUserProfilePhotos` int(11) NOT NULL,
  `PhotoSize_idPhotoSize` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  PRIMARY KEY (`idUserProfilePhotos`,`PhotoSize_idPhotoSize`),
  KEY `fk_UserProfilePhotos_has_PhotoSize_PhotoSize1_idx` (`PhotoSize_idPhotoSize`),
  KEY `fk_UserProfilePhotos_has_PhotoSize_UserProfilePhotos_idx` (`idUserProfilePhotos`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `video` (
  `idVideo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'This object represents a video file.',
  `file_id` varchar(45) NOT NULL COMMENT 'Unique identifier for this file',
